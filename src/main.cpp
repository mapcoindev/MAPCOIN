...
const string strMessageMagic = "MAPCOIN Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "MAPCOIN", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Sun, 06 Sep 2015 16:52:11 GMT";
        CTransaction txNew;
        txNew.nTime = 1441558331;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1441558333;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 6545140;
		if(fTestNet)
        {
            block.nNonce   = 6545140;
        }
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x955e4d17b2516e51d049963a3df4890bed5da526161ebbad632c2523c3b874af"));
        block.print();
